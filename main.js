class Slider {
  constructor(option) {
    ...
    this.interval = isNaN(option.interval) == true ? this.time + 1000 : option.interval < this.time + 1000 ? console.error("interval animatsiyadan kichik bo'lishi mumkin emas") : option.interval
